...
<spring:url value="/resources/js/bootstrap.min.js" var="bootsJS"></spring:url>
<spring:url value="/resources/css/bootstrap.min.css" var="bootsCSS"></spring:url>
...
<link href="${bootsCSS}" rel="stylesheet"/>
<script type="text/javascript" src="${bootsJS}"></script>
